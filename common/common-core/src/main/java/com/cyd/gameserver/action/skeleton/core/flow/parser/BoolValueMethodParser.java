...
import com.cyd.gameserver.action.skeleton.protocol.wrapper.BoolValue;
import com.cyd.gameserver.action.skeleton.protocol.wrapper.BoolValueList;
...
final class BoolValueMethodParser implements MethodParser {
    ...
    public Object parseParam(byte[] data, ActionCommand.ParamInfo paramInfo) {
        ...
        if (paramInfo.isList()) {
            ...
            BoolValueList valueList = ProtoDataCodec.decode(data, BoolValueList.class);
        ...
        BoolValue boolValue = ProtoDataCodec.decode(data, BoolValue.class);
