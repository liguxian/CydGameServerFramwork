...
import com.cyd.gameserver.action.skeleton.protocol.wrapper.IntValue;
import com.cyd.gameserver.action.skeleton.protocol.wrapper.IntValueList;
...
final class IntValueMethodParser implements MethodParser {
    ...
    public Object parseParam(byte[] data, ActionCommand.ParamInfo paramInfo) {
        ...
        if (paramInfo.isList()) {
            ...
            IntValueList valueList = ProtoDataCodec.decode(data, IntValueList.class);
        ...
        IntValue intValue = ProtoDataCodec.decode(data, IntValue.class);
