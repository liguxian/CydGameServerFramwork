...
import com.cyd.gameserver.action.skeleton.protocol.wrapper.LongValue;
import com.cyd.gameserver.action.skeleton.protocol.wrapper.LongValueList;
...
final class LongValueMethodParser implements MethodParser {
    ...
    public Object parseParam(byte[] data, ActionCommand.ParamInfo paramInfo) {
        if (paramInfo.isList()) {
            ...
            LongValueList valueList = ProtoDataCodec.decode(data, LongValueList.class);
        ...
        LongValue longValue = ProtoDataCodec.decode(data, LongValue.class);
