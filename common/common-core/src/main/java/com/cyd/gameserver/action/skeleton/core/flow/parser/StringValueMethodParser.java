...
import com.cyd.gameserver.action.skeleton.protocol.wrapper.StringValue;
import com.cyd.gameserver.action.skeleton.protocol.wrapper.StringValueList;
...
final class StringValueMethodParser implements MethodParser {
    ...
    public Object parseParam(byte[] data, ActionCommand.ParamInfo paramInfo) {
        ...
        if (paramInfo.isList()) {
            ...
            StringValueList valueList = ProtoDataCodec.decode(data, StringValueList.class);
        ...
        StringValue stringValue = ProtoDataCodec.decode(data, StringValue.class);
